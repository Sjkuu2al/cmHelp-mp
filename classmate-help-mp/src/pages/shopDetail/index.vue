    ...
    <form @submit="formSubmit">
      ...
      <view class="edit-part">
        ...
        <radio-group @change="radioChange">
          <label class="radio"
            ><radio value="0" :checked="form.radioType === '0'" />教材</label
          >
          <label class="radio"
            ><radio value="1" :checked="form.radioType === '1'" />衣物</label
          >
          <label class="radio"
            ><radio value="2" :checked="form.radioType === '2'" />电子</label
          >
          <label class="radio"
            ><radio value="3" :checked="form.radioType === '3'" />其他</label
          >
        </radio-group>
      </view>
      <view class="edit-part">
